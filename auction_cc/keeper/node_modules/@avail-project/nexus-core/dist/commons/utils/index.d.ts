import { ChainMetadata, SUPPORTED_CHAINS_IDS, SUPPORTED_TOKENS, TokenMetadata, EthereumProvider, TransactionReceipt } from '../types/index';
 ...
 */
export declare function getTokenContractAddress(token: SUPPORTED_TOKENS, chainId: SUPPORTED_CHAINS_IDS): string | undefined;
export { LOG_LEVEL, setExceptionReporter, setLogLevel, getLogger, logger, type LogLevel, type ExceptionReporter, } from '../utils/logger';
