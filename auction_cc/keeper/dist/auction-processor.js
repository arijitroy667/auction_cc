...
const nexus_core_1 = require("@avail-project/nexus-core");
...
const UNISWAP_V3_SWAP_ABI_json_1 = __importDefault(require("../src/ABI/UNISWAP_V3_SWAP_ABI.json"));
// Initialize Nexus SDK
const nexusSDK = new nexus_core_1.NexusSDK({ network: 'testnet' });
...
function getUniswapV3RouterAddress(chainId) {
...
async function settleCrossChainAuction(intentId, auction, winner, allBids, sourceChain) {
    try {
        ...
        if (!nexusSDK.isInitialized()) {
            const keeperWallet = new ethers_1.ethers.Wallet(config_1.CONFIG.keeperPrivateKey, sourceProvider);
        ...
        if (winnerTokenSymbol === requiredTokenSymbol) {
            ...
            const bridgeAndExecuteResult = await nexusSDK.bridgeAndExecute({
                ...
                execute: {
                    ...
                    contractAbi: UNISWAP_V3_SWAP_ABI_json_1.default,
